const products = {
  1: {
   ...
   2: {
    ...
    description6:"",
    heading: "Recommended For:",
    keyfeatures1: "1. Vineyards, chili fields, and paddy growers facing seasonal fungal pressure.",
    keyfeatures2: "2. Use at early disease onset or as part of a scheduled fungicide rotation.",
    keyfeatures3: "3. Integrated crop protection programs for sustainable disease management.",
  },
  3: {
    id: 3,
    name: "Reymon",
    ...
    description6:"",
    heading: "Recommended For:",
    keyfeatures1: "1. Rice growers dealing with blast, sheath blight, and other paddy fungal infections.",
    keyfeatures2: "2. Use during early stages of disease appearance or as a preventive measure.",
    keyfeatures3: "3. Suitable for inclusion in fungicide rotation programs to delay resistance build-up.",
  },
  4: {
    id: 4,
    name: "Rover",
    ...
    heading: "Recommended For:",
    keyfeatures1: "1. Farmers growing rice, tomato, and potato facing fungal threats like sheath blight and early blight.",
    keyfeatures2: "2. Use at early signs of disease or as a preventive measure before favorable disease conditions",
    keyfeatures3: "3.Suitable for integrated disease management programs across varied agro-climatic zones.",
  },
 5: {
      id: 5,
    name: "Fasten V",
    ...
    description6: "Compatibility: Fits well into integrated pest management programs.",
    heading: "Recommended For:",
    keyfeatures1: "1. Apple growers needing effective scab management.",
    keyfeatures2: "2. Use at early signs of disease or preventively during high-risk periods.",
    keyfeatures3: "3.Ideal for integrated orchard disease control programs",
  },
  6: {
    id: 6,
    name: "Cosmos",
    ...
    description6:"",
    heading: "Recommended For:",
    keyfeatures1: "1. Farmers cultivating coffee, banana, wheat, tea, rice, and groundnut under fungal disease pressure.",
    keyfeatures2: "2. Use as a preventive spray or at the first sign of infection.",
    keyfeatures3: "3. Well-suited for rotational use in disease management programs.",
  },
  7: {
    id: 7,
    name: "Sloth",
    ...
    description6:"",
    heading: "Recommended For:",
    keyfeatures1: "1. Farmers targeting Downy mildew, Leaf & Fruit spots, Early/Late blight, and Scab.",
    keyfeatures2: "2. Suitable for orchards and vegetable crops across seasons.",
    keyfeatures3: "3. Preventive application in high-risk weather conditions.",
  },
  8: {
    id: 8,
    name: "Finix",
    ...
    description6:"",
    heading: "Recommended For:",
    keyfeatures1: "1. Farmers needing reliable fungal protection during peak infection periods.",
    keyfeatures2: "2. Effective choice for chilli and soybean growers facing disease outbreaks.",
    keyfeatures3: "3. Suitable for integrated disease management programs.",
  },
  9: {
    id: 9,
    name: "Chester",
    ...
    description6:"",
    heading: "Recommended For:",
    keyfeatures1: "1. Farmers managing critical fungal diseases in wheat, rice, chilli, onion, and groundnut.",
    keyfeatures2: "2. Ideal for early intervention or ongoing disease outbreaks during vulnerable crop stages.",
    keyfeatures3: "3. Compatible with integrated pest and disease management strategies.",
  },
  10: {
    id: 10,
    name: "Civet",
    ...
    heading: "Recommended For:",
    keyfeatures1: "1. Farmers growing rice, mango, tomato, chilli, grapes, and wheat.",
    keyfeatures2: "2. Use during early signs or preventive stages of fungal disease outbreaks",
    keyfeatures3: "3. Ideal during wet or humid weather conditions that favor fungal growth.",
  },
  11: {
    id: 11,
    name: "Spencer",
  ...
  12: {
    ...
    description6:"",
    heading: "Ideal For:",
    keyfeatures1: "1. Farmers in regions prone to blast outbreaks or high humidity.",
    keyfeatures2: "2. Use during early vegetative to booting stages in rice.",
    keyfeatures3: "3.Those seeking long-lasting protection with fewer applications.",
  },
  13: {
    id: 13,
    name: "Blutox",
    ...
    heading: "Recommended For:",
    keyfeatures1: "1. Grape growers dealing with high disease pressure from mildews and anthracnose.",
    keyfeatures2: "2. Pre-monsoon applications to protect vulnerable crop stages.",
    keyfeatures3: "3. Farmers seeking preventive solutions with strong field persistence.",
  },
  14: {
    id: 14,
    name: "Chinav",
    ...
    heading: "Recommended For:",
    keyfeatures1: "1. Sorghum & Sunflower: Effective against Downy Mildew.",
    keyfeatures2: "2. Mustard: Controls White Rust effectively during early growth stages.",
    keyfeatures3: "3. Maize: Provides protection from Sorghum Downy Mildew, Sugarcane Downy Mildew, Philippine Downy Mildew, and Brown Stripe Downy Mildew.",
  },
  15: {
    id: 15,
    name: "Deltamycin",
    ...
    description6:"",
    heading: "Recommended For:",
    keyfeatures1: "1. Apple: Effective against Fire Blight, helping protect blossoms and twigs during critical growth stages.",
    keyfeatures2: "2. Beans: Controls Halo Blight, preventing lesions and leaf damage.",
    keyfeatures3: "3. Cotton: Manages Seedling Blight, Angular Leaf Spot, and Black Arm Disease to promote healthy vegetative growth.",
    keyfeatures4: "4. Citrus: Treats Citrus Canker, maintaining fruit health and reducing blemishes.",
    keyfeatures5: "5. Vegetables (e.g., Potato, Tomato): Protects against Black Leg, Soft Rot, Brown Wilt, and Ring Bangle Disease, reducing rot and ensuring better yield.",
  },
  16: {
    id: 16,
    name: "Mixology",
    ...
    description6:"",
    heading: "Recommended For:",
    keyfeatures1: "1. Farmers facing repeated downy mildew or late blight outbreaks.",
    keyfeatures2: "2. Use during early signs of infection or as a preventive measure.",
    keyfeatures3: "3.Suitable for vegetable and vineyard growers seeking strong resistance management.",
  },
