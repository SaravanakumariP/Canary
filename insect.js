...
const products = {
  1: {
    ...
    description:"Dinotefuran 20% SG is used to controlof brown plant hopper in paddy and Aphids, Jassids, thrips and white fly in cotton crop.",
   ...
   2: {
    id: 2,
    name: "Canary Ace",
    description:"Acephate 95% SG is an organo phosphorus insecticides used to control stem borer, leaf folder, brgano hoppersrgano ",
  ...
  3: {
   ...
   4: {
    id: 4,
    name: "Fatak",
    image: "./images/ins10.png",
    description:" Flubendiamide 20% WG is a water‐dispersible granule insecticide designed for effective control of lepidopteran pests by targeting their calcium regulation, delivering rapid action and prolonged residual protection in crops.",
  ...
  5: {
    id: 5,
    name: "Truestar",
    image: "./images/truestar.png",
    description:"Thiamethoxam 25% WG is used control of Stem Borer Gall Midge. Leaf Folder, Brown plant hopper, (BPH), White Backed Plant Hoper (WBPH), Green Leaf Hopper (GLH). Thrips on Rice crop; Jassids, aphids, whiteflies in Cotton and okra, Hoppers in mango, Aphids in wheat and mustard; Whiteflies in Tomato, Brinjal, Mosquito Bug in tea & aphids in potato.",
   ...
   6: {
    ...
    description:"Emamectin Benzoate 5% SG is used to control of bollworms on cotton, fruit and shoot borer o n okra.",
  ...
  7: {
    ...
    description:"Imidacloprid 70% WG is used to for the control jassids, aphids and thrips in cotton, brown planthopper and white backed plant hopper in rice, aphids, jassids and thrips in Okra and aphids, jassids and thrips in cucumber crops. .",
  ...
  8: {
    ...
    description:"Tolfenpyrad 15% EC is used to control of diamond back moth and aphid in Cabbage, aphid, thrips, Powdery mildew, Anthracnose on Chilli, Cotton, Cumin, Chilli, Mango and Onion.",
   ...
   9: {
    ...
    description:"Novaluron 10% EC is used to control pod borer (hellothisarmigera) in Bengal Gram (Chick Pea); Diamond back moth and Tobacco Leaf in Cabbage; fruit borer and Tobacco leaf eating Caterpillar in Chilli; Anopheles Stephensi, Aedes aegypti in clear surface water; American Bollworm and Tobacco leaf eating caterpillar in Cotton; Culex Quinquefasciatus, Anopheles subpictus in polluted surface water; fruit borer in Tomato.",
  ...
  10: {
    ...
    description:"Propargite 57% EC is used for the control European Red mite, Two Spotted Mite on Apple; Two spotted spider mite (Tetranychus Urticae) in Brinjal; Mite in Chillies and Red Spider Mite in Tea.",
  ...
  11: {
    id: 11,
    name: "Chingu",
    image: "./images/chigu.png",
    description:"Acetamiprid 0.4% + Chlorpyrifos 20% w/w EC is a premix emulsifiable concentrate concentrate containing acetamiprid a.i. 4gm per litre and Chlorpyrfosa.i @ 200gm per lit formulation. Acetamiprid 0.4% + Chlorpyrifos 20% w / w EC is u s e d t o control s t e m borer b r o w n plant hopper white backed Plant hopper.",
   ...
   12: {
    ...
    description:"Emamectin Benzoate 1.9% EC is a powerful, broad‑spectrum insecticide with both contact and systemic action, specifically formulated to control chewing/lepidopteran pests (like bollworms, fruit borers, leaf folders) at low doses by disrupting their nerve (chloride channel) function, causing paralysis and death .",
  ...
  13: {
    ...
    description:"Thiamethoxam 30% FS is used to control Jassids, aphids and whitefly in cotton, Termites in wheat, shoot fly on sorghum and maize, jassid in okra, thrips, GLH and whorl maggot in rice and jassid and thrips in sunflower, stem fly in soyabean and thrips in chilli crop.",
  ...
  14: {
    ...
    description:"Bifenthrin 8% SC is a broad-spectrum insecticide having contact and stomach action against red spider mites and tea mosquito bugs in tea and mites in apple. It c o n t a i n s 8% w/w active ingredients Bifenthrin with other relevant ingredients.",
   ...
   15: {
    id: 15,
    name: "Thianil",
    image: "./images/fipro+thia.png",
    description:"Tianil SC combines fipronil (4%) and thiamethoxam (4%) in a suspension concentrate that offers immediate knockdown through contact/stomach action (from fipronil) and long-lasting systemic protection via plant uptake (due to thiamethoxam). This synergy ensures pests stop feeding soon after exposure and maintains field protection over time.",
  ...
  16: {
    ...
    description:"Bifenthrin 10% EC is a broad spectrum insecticide having contact and stomach action against bollworm and sucking pests white fly in Cotton and leaf folder, green leaf hopper and stem borer in rice and termites in sugarcane. ",
  ...
  17: {
    ...
    description:"Triflumezopyrim 10% w/w SC (10.6% w/v) is used to control Brown Plant Hopper (Nilaparvata Lugens), White Backed Plant Hopper (Sogatella Furcifera) in Paddy crop.",
  ...
  18: {
    ...
    description:"Fenazaquin 18.3 % SC is used to control Red Spider Mite(Tetranyehusurticae) in rice crop. ",
  ...
  19: {
    ...
    description:"Chlorantraniliprole 4.3% + Abamectin 1.7% SC is used to control Thrips, Mites & Fruit borer in Chilli.",
  ...
  20: {
    ...
    description:"Diafenthiuron 47.8% SC is a broad spectrum non-systemic insecticide having contact and stomach activity is used for control of aphids, jassids, thrips & whiteflies in cotton crop. diafenthiuron belongs to group 12A of insecticide mode of action. ",
  ...
  21: {
    ...
    description:"Fipronil 18.87% w/w SC is used to control of thrips in cotton. ",
   ...
   22: {
    ...
    name: "Neutron",
    image: "./images/ins15.png",
    description:"Novaluran 5.25% + Emamectinbenzoate 0.9% SC is used for the control of diamond back moth (DBM) & tobacco caterpillar on Cabbage; Gram, Pod Bores & Tobacco Caterpillar in Chilli, gram pod bores in Red, Gram and stem borer in Rice. ",
   ...
   23: {
    ...
    description:"Fenazaquin 10% EC is used to control Red Spider mite, Two Spotted mite on Apple; Red Spider mite on Brinjal and okra; Yellow mite on chilli; Red Spider Mite, Pink mite, Purple Mite on Tea; Two spotted spider mite o n Tomato. ",
  ...
  25: {
   ...
   26: {
    ...
    description:"Imidacloprid 6% + Lambda cyhalothrin 4% SL is used to control stem borer, hipsa, plant hopper and Gundhi bug in paddy crop. ",
  ...
  27: {
    id: 27,
    name: "Fullon",
    image: "./images/fullon.png",
    description:"Chlorpyriphos 20% CS is used to control Brown plant hopper (Nilaparavatalugens), Green leaf hopper (Nephoteuix Virescens), White backed plant hopper (Sogatella Furcifera) on paddy.",
  ...
  28: {
    ...
    description:"Lufenuron 5.4% EC is used to control Diamond Back Moth (DBM)in cabbage.",
  ...
  29: {
    ...
    description:"Lambda chalothrin 2.5% EC is used to control bollworms, jassid, Thrips on cotton crop.",
  ...
  30: {
    ...
    description:"Chlorpyriphos 50% EC is used to control Termites in Building during construction and in existing building. ",
  ...
  31: {
    ...
    description:"Profenofos 40% + Cypermethrin 4% EC is used to control Bollworm on Cotton. ",
  ...
  32: {
    id: 32,
    name: "BOA 505",
    image: "./images/boa 505.png",
    description:"Chlorpyriphos 50% + Cypermethin 5% EC is recommended to control Aphid, Jassid, Thrips, Whitefly, American Bollworm, Spotted bollworm, Pink Boll Worm, Spodoptera Litura of Cotton.",
  ...
  33: {
    ...
    description:"Lambda Cyhalothrin 5% EC is used to control bollworms, jassid, Thrips on cotton crop. ",
...
34: {
    id: 34,
    name: "Jackel",
    image: "./images/jackel.png",
    description:"Cypermethin 25% EC synthetic pyrethroid for Killing various insects Bollwoms, Jassids and Thrips on cotton; Shoot and fruit borers on Bhindi; Shoot and Fruit borer, Jassids Epilachna grab on Brinjal.",
  ...
  35: {
    ...
    description:"Cypermethin 10% EC is recommended to control spotted American & Pink bollworms of cotton, Diamond back moth of cabbage, fruit borer of okra, fruit & shoot borers of Sugarcane Shoot fly of wheat bihar hairy caterpillar of Sunflower.",
  ...
  36: {
    id: 36,
    name: "Cavach",
    image: "./images/cavach.png",
    description:"Chlorpyriphos 20% EC is used to control Hispa, Leaf Roller, Gall Miage, Stem borer on paddy, Black bug, Pod borer on Beans, Cut worm on Gram, Black bug, Early Shoot & Stalk borer Pyrille on Sugarcane, Aphid, Bollworm, white fly, cut worm on Cotton, Aphid, Root grub on Groundnut, Shoot and fruit borer on Mustard, and Brinjal Diamond Backmoth on Cabbage, root grub on Onion, aphid, leaf hopper, black citrus on Apple and to control termite in building and wood.",
  ...
  39: {
    ...
    description:"Diafenthiuron 50% WP is a broad spectrum Insecticide. It is recommended for its use to control Whiteflies, aphids, Thrips, Jassids in Cotton and Diamond Back Moth (DBM) in Cabbage, Mites in Chilli, White Fly in Brinjal,Thirps Capsule borer in Cardamom.",
  ...
  42: {
   ...
   43: {
    ...
    description:"Acetamiprid 20% SP is used for control of aphids, jassids and white flies in coton.",
  ...
  46:{
    ...
    description:"Dinotefuran 4% + Acephate 50% SG is used to control Aphids, Jassid, Thrips & White flies in Cotton; Brown Plant Hopper & White backed Plant Hopper in Rice crop.",
   ...
   47: {
    ...
    description:"Carbofuran 3% CG is used to control aphid jassid in Barely, Potato crop. It is used to control shoot fly in Bajra, Sorghum, Maize Crop. It is used to Brown plant hopper, Gall midge, Green Leaf hopper in Paddy. It is used to control Rhizome weevil, Aphid, Nematode on Banana, Cabbage and Citrus Crop and white grub of groundnut, top borer of sugarcane.",
  ...
  48: {
    ...
    description:"Chlorpyriphos 10% GR is used to control Stem Borer, Leaf roller, Gal midge of Rice.",
