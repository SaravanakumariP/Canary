const products = {
  1: {
    ...
    description:"Azoxystrobin 23% SC is used to control Downy mildew, Powdery mildew in Grapes, Leaf and fruit spot in Pomegranate, Anthracnose, Powdery mildew in Mango; Late blight in potato, Downy mildew powdery mildew in Cucumber, Blight & Powdery mildew in Cumin; Early and late blight in tomato; Fruit rot, Powdery mildew in Chilli. ",
  ...
  4: {
    ...
    description:"Thifluzamide 24% SC is used to control sheath blight in Rice; Early blight inTomato and Black scurf on Potato. ",
 ...
 5: {
  ...
  6: {
   ...
   7: {
    id: 7,
    name: "Fasten",
    image: "./images/fasten.png",
    description:"Hexaconazole 5% SC is used to control of powdery mildew of Mango and Grapes; Sheath blight in Rice. ",
    descript:"Cosmos is a broad-spectrum systemic fungicide formulated with Propiconazole 25% EC, designed to provide reliable and long-lasting control of multiple fungal diseases across diverse crops. It works by inhibiting ergosterol biosynthesis in fungi, halting the development of fungal cell membranes. This results in rapid curative action and effective prevention, particularly against rusts, leaf spots, blights, and bunts.",
    descript1:"By reducing disease pressure during critical growth stages, Cosmos supports healthy plant development and helps in achieving higher yields and better crop quality. It is ideal for use during early disease onset or as a preventive spray in seasonal disease cycles, and integrates well with resistance management strategies.",
    description1:"Key Benefits:",
    description2:"Broad-spectrum control across multiple crops.",
   ...
   8: {
    id: 8,
    name: "Halloween",
    image: "./images/hallowen.png",
    description:"Carbendazim 46.27% SC used for the control of Powdery mildew of grapes and mango.",
    descript:"Cosmos is a broad-spectrum systemic fungicide formulated with Propiconazole 25% EC, designed to provide reliable and long-lasting control of multiple fungal diseases across diverse crops. It works by inhibiting ergosterol biosynthesis in fungi, halting the development of fungal cell membranes. This results in rapid curative action and effective prevention, particularly against rusts, leaf spots, blights, and bunts.",
    descript1:"By reducing disease pressure during critical growth stages, Cosmos supports healthy plant development and helps in achieving higher yields and better crop quality. It is ideal for use during early disease onset or as a preventive spray in seasonal disease cycles, and integrates well with resistance management strategies.",
    description1:"Key Benefits:",
    description2:"Broad-spectrum control across multiple crops.",
   ...
   9: {
    id: 9,
    name: "Triblast",
    image: "./images/triblast.png",
    description:"Tricyclazole 75% WP is recommended for the control of blast disease of rice crop.",
    descript:"Cosmos is a broad-spectrum systemic fungicide formulated with Propiconazole 25% EC, designed to provide reliable and long-lasting control of multiple fungal diseases across diverse crops. It works by inhibiting ergosterol biosynthesis in fungi, halting the development of fungal cell membranes. This results in rapid curative action and effective prevention, particularly against rusts, leaf spots, blights, and bunts.",
    descript1:"By reducing disease pressure during critical growth stages, Cosmos supports healthy plant development and helps in achieving higher yields and better crop quality. It is ideal for use during early disease onset or as a preventive spray in seasonal disease cycles, and integrates well with resistance management strategies.",
    description1:"Key Benefits:",
    description2:"Broad-spectrum control across multiple crops.",
  ...
  13: {
    ...
    description:"Tebuconazole 50% + Trifloxystrobin 25% WG  is a systemic fungicide used for the control of  heath blight, leaf blast and neck blast, glume  iscoloration (dirty panicle) in rice crop; early  light in tomato crop; powdery mildew,  nthracnose in mango crop; yellow rust, powdery  ildew in wheat crop; powdery mildew in grape  rop; powdery mildew, anthracnose, alternaria  eaf spot in chilli crop.",
  ...
  14: {
    ...
    description:"Azoxystrobin 11.5% + Mancozeb 30% w/w WP is a dual-action broad‑spectrum fungicide that combines systemic protection (azoxystrobin inhibiting fungal respiration) with contact control (mancozeb preventing spore germination), offering both preventive and curative disease control, long residual activity, and improved crop health .",
    descript:"Render works efficiently to control key pests such as brown plant hopper in paddy and aphids, jassids, thrips, and whiteflies in cotton crops. Its unique action provides both immediate knockdown and long-lasting residual effect, helping protect crop health and maximize yield.",
    descript1:"This insecticide is ideal for modern farming needs, supporting Integrated Pest Management (IPM) practices with minimal impact on beneficial insects when used as directed",
    description1:"Key Benefits:",
    description2:"Fast Action: Delivers quick knockdown of target pests, minimizing damage.",
  ...
  16: {
    id: 16,
    name: "Copter",
    image: "./images/Copter.png",
    description: "Copper Oxychloride 50% WP is used to control leaf spot, fruit rot, in Banana, betal, and chillies crop; Canker, foot rod in Citrus crop; Clump rot, leaf rot in cardamom; Black rot rust in coffee; blight in Cumin; Brown leaf spot in Paddy, Bud Rot in Coconut, Early blight and late blight in Potato, Blister blight , Black Rot, Red rust in Tea, Frog eye leaf spot , Black Shank in Tobacco, Early blight, late blight leaf sport in Tomato,Downy mildew in grapes.",
    descript:"Hanzo is a unique combination fungicide with both antibiotic and systemic fungicidal properties. It effectively targets blast and sheath blight in paddy crops, two of the most damaging rice diseases. Kasugamycin offers strong bactericidal action, while Thifluzamide provides deep systemic control of fungal infections. The synergy between these two active ingredients ensures a wide range of protection with long residual activity.",
    descript1:"This formulation not only protects the crop during early stages but also supports healthier tillering and improved grain filling during reproductive stages.g gbb",
    description1:"Key Benefits:",
    description2:"Dual-action: antibacterial (Kasugamycin) + antifungal (Thifluzamide).",
  ...
  18: {
    ...
    description: "Metalaxyl 35% WS is used for the control of downy mildew on Sorghum and Sunflower; white rust in Mustard; Sorghum downy mildew, Sugarcane downy mildew, Phillippine downy mildew, Brown stripe downy mildew onMaize.",
  ...
  19: {
    ...
    description: "Streptomycin Sulphate + Tetracycline Hydrochloride is used to control fire blight in Apple, Halo Blight in Beans, Citrus Canker in Citrus, Seeding blight, angular leaf sport or black arm disease in cotton; Black leg & soft for bacterial, brown wild or ring bangles disease on potato.",
  ...
  20: {
    id: 20,
    name: "Star 80",
    image: "./images/star80.png",
    description: "Sulphur 80% WDG is used to control powdery mildew on Grapes, Mango, Cumin and Cowpea, Guar; Scab in Apple.",
    descript:"Hanzo is a unique combination fungicide with both antibiotic and systemic fungicidal properties. It effectively targets blast and sheath blight in paddy crops, two of the most damaging rice diseases. Kasugamycin offers strong bactericidal action, while Thifluzamide provides deep systemic control of fungal infections. The synergy between these two active ingredients ensures a wide range of protection with long residual activity.",
    descript1:"This formulation not only protects the crop during early stages but also supports healthier tillering and improved grain filling during reproductive stages.g gbb",
    description1:"Key Benefits:",
    description2:"Dual-action: antibacterial (Kasugamycin) + antifungal (Thifluzamide).",
  ...
  21: {
    id: 21,
    name: "Carman",
    image: "./images/carman.png",
    description: "Carbendazim 12% + Mancozeb 63% WP is used to control of early blight, late blight, black scurf in potato, blister blight, Grey blight, Red rust, Die-black rot in Tea, blast in Paddy, leaf sport, blast in Groundnut..",
    descript:"Hanzo is a unique combination fungicide with both antibiotic and systemic fungicidal properties. It effectively targets blast and sheath blight in paddy crops, two of the most damaging rice diseases. Kasugamycin offers strong bactericidal action, while Thifluzamide provides deep systemic control of fungal infections. The synergy between these two active ingredients ensures a wide range of protection with long residual activity.",
    descript1:"This formulation not only protects the crop during early stages but also supports healthier tillering and improved grain filling during reproductive stages.g gbb",
    description1:"Key Benefits:",
    description2:"Dual-action: antibacterial (Kasugamycin) + antifungal (Thifluzamide).",
  ...
  22: {
    id: 22,
    name: "Carben",
    image: "./images/Carben.png",
    description: "Carbendazim 50% WP is used to control blast & sheath blight of Paddy, leaf spots and powdery mildew in Moong, Leaf Spot in Cotton, Tikka leaf spot in Groundnut, Powdery Mildew in Peas, leaf spot and fruit rot in Brinjal loose smut of wheat & barely, brown rot of brinjal, anthrancnose of Grapes.",
    descript:"Hanzo is a unique combination fungicide with both antibiotic and systemic fungicidal properties. It effectively targets blast and sheath blight in paddy crops, two of the most damaging rice diseases. Kasugamycin offers strong bactericidal action, while Thifluzamide provides deep systemic control of fungal infections. The synergy between these two active ingredients ensures a wide range of protection with long residual activity.",
    descript1:"This formulation not only protects the crop during early stages but also supports healthier tillering and improved grain filling during reproductive stages.g gbb",
    description1:"Key Benefits:",
    description2:"Dual-action: antibacterial (Kasugamycin) + antifungal (Thifluzamide).",
  ...
  23: {
    id: 23,
    name: "Tamboora",
    image: "./images/tamboora.png",
    description: "Thiophanate Methyl 70% WP is used to control powdery mildew in Cucurbits, and Papaya; Fusarium Wilt in Pigeon pea; Brown rust, leaf blight in Wheat; Ring rot in Tomato; Anthracnose in Bottle gourd; Scab in Apple.",
    descript:"Hanzo is a unique combination fungicide with both antibiotic and systemic fungicidal properties. It effectively targets blast and sheath blight in paddy crops, two of the most damaging rice diseases. Kasugamycin offers strong bactericidal action, while Thifluzamide provides deep systemic control of fungal infections. The synergy between these two active ingredients ensures a wide range of protection with long residual activity.",
    descript1:"This formulation not only protects the crop during early stages but also supports healthier tillering and improved grain filling during reproductive stages.g gbb",
    description1:"Key Benefits:",
    description2:"Dual-action: antibacterial (Kasugamycin) + antifungal (Thifluzamide).",
  ...
  24: {
    id: 24,
    name: "Bushtit",
    image: "./images/bushitit.png",
    description: "Metalaxyl 8% + Mancozeb 64% WP is used to control Downy Mildew in Grapes and pearl millet, Late blight in Potato.",
    descript:"Hanzo is a unique combination fungicide with both antibiotic and systemic fungicidal properties. It effectively targets blast and sheath blight in paddy crops, two of the most damaging rice diseases. Kasugamycin offers strong bactericidal action, while Thifluzamide provides deep systemic control of fungal infections. The synergy between these two active ingredients ensures a wide range of protection with long residual activity.",
    descript1:"This formulation not only protects the crop during early stages but also supports healthier tillering and improved grain filling during reproductive stages.g gbb",
    description1:"Key Benefits:",
    description2:"Dual-action: antibacterial (Kasugamycin) + antifungal (Thifluzamide).",
  ...
  25: {
    ...
    id: 26,
    name: "M-45",
    image: "./images/Mancozeb M-45 New.png",
    description: "Mancozeb 75% WP is used to control light blight, early blight in potato, late blight buck eye rot leaf sport in Tomato; Leaf spot, brown and black rust, blight in wheat, Leaf Blight, Downy Mildew on Maize; blast on paddy; Leaf spot in Jawar, Tip rot, Sigatoka leaf spot, Cigarend rot in banana, Scab & sooty blotch in Apple, Angular leaf spot, downy mildew in grapes; fruit rot in Guava. ",
    descript:"Mixology is a powerful combination fungicide that offers both systemic and contact action. It is highly effective in managing downy mildew in grapes and cucumber, as well as late blight in potato and tomato crops. Cymoxanil acts quickly within the plant system to stop the development of fungal infections, while Mancozeb creates a protective barrier on the plant surface to prevent new infections.",
    descript1:"With its dual mechanism, Mixology ensures rapid disease suppression, reliable prevention, and enhanced crop resilience even under high disease pressure.",
    description1:"Key Benefits:",
    description2:"Dual-action: Internal and external disease control.",
    ...
    id: 27,
    name: "Canzole",
    image: "./images/canzole.png",
    description: "Tebuconazole 25.9% EC is used to control blast sheath blight in rice; Fruit rot, Powdery mildew in Chilli, Tikka and Rust in Groundnut.",
    descript:"Mixology is a powerful combination fungicide that offers both systemic and contact action. It is highly effective in managing downy mildew in grapes and cucumber, as well as late blight in potato and tomato crops. Cymoxanil acts quickly within the plant system to stop the development of fungal infections, while Mancozeb creates a protective barrier on the plant surface to prevent new infections.",
    descript1:"With its dual mechanism, Mixology ensures rapid disease suppression, reliable prevention, and enhanced crop resilience even under high disease pressure.",
    description1:"Key Benefits:",
    description2:"Dual-action: Internal and external disease control.",
